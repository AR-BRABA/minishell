...
/*   Updated: 2025/01/19 15:47:52 by jgils            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**list_to_char_array(t_node *token)
{
	...
	args = (char **)malloc(sizeof(char *) * (count + 1));
		// criar um array de strings para passar para o ft_echo
	if (!args)
	{
	...
	arg_token = token;
	// voltar p/o 1º argumento e depois copiar os args p/o array
	i = 0;
	while (arg_token && arg_token->type == ARG)
	// preencher o array de argumentos;
	{
		...
		// copiar o valor do token p/o array de args
		arg_token = arg_token->next;
	}
	args[i] = NULL;
	return (args);
